...
class Network2PC : public testing::Test {
 protected:
  void SetUp() override {
    auto job1 = std::make_shared<mpc::job_2p_t>(mpc::party_t::p1, mpc_runner_t::test_pnames[0],
                                               mpc_runner_t::test_pnames[1]);
    auto job2 = std::make_shared<mpc::job_2p_t>(mpc::party_t::p2, mpc_runner_t::test_pnames[0],
                                               mpc_runner_t::test_pnames[1]);
